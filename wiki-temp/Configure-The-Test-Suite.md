...
* `type`: defines the **set** type.
  * `baseline`: The catalogue collections' **set** refers to [Common Baseline Sets](Catalogue-Sets#common-baseline-sets) defined globally in the [`data` node](#data-node). It requires the `reference_set_id` setting to set the Baseline set identifier. Those sets are used in [TC501](Test-Scenarios-Description#tc501), [TC502](Test-Scenarios-Description#tc502), [TC601](Test-Scenarios-Description#tc601) & [TC602](Test-Scenarios-Description#tc602)).
